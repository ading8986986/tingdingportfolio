...
layout: post
title:  "Android NDK"
date:   2018-06-16 13:10:51 +0800
categories: Android
tags: Android
description: Frameworks in Android.
---

### NDK

The Native Development Kit (NDK) is a set of tools that allows you to use C and C++ code with Android. the NDK can be useful for cases in which you need to do one or more of the following:
...
* CMake.
* Standalone toolchains for integration with other build systems, or use with configure-based projects. (You should consider using a standalone toolchain if you are building an open-source library (for example when invoking a configure script).)
